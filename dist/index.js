...
(function (AppHelpers) {
  ...
  //    */
    ...
    AppHelpers.subtractDays = subtractDays;
    function stringToDate(dateString = "") {
        return new Date(dateString);
    }
    AppHelpers.stringToDate = stringToDate;
    function dateToString(date) {
        return date.toISOString().split("T")[0];
    }
    AppHelpers.dateToString = dateToString;
    /* -------------------------------------------------------------------------- */
    /*                                   Format                                   */
    /* -------------------------------------------------------------------------- */
    /**
    ...
    AppHelpers.prettyText = prettyText;
    /**
    ...
    AppHelpers.prettyFileSize = prettyFileSize;
    /**
     ...
     */
    function prettyDate(dateInput, withHours = true, withYear = true) {
    ...
    AppHelpers.prettyDate = prettyDate;
    /**
     ...
     */
    function prettyPrice(amount, currency = "usd", decimalPlaces = 2, withSymbol = true) {
    ...
    AppHelpers.prettyPrice = prettyPrice;
    /**
    ...
    AppHelpers.capitalizeFirstLetter = capitalizeFirstLetter;
    ...
    AppHelpers.toKebabCase = toKebabCase;
    /* -------------------------------------------------------------------------- */
    /*                                    Other                                   */
    /* -------------------------------------------------------------------------- */
    /**
    ...
    AppHelpers.generateSequence = generateSequence;
    /**
    ...
    AppHelpers.decodeUrlText = decodeUrlText;
     ...
     */
    function convertPriceFromCents(priceInCents, decimalPlaces = 2) {
        const price = priceInCents / 100;
        return price.toFixed(decimalPlaces);
    }
    AppHelpers.convertPriceFromCents = convertPriceFromCents;
    /**
    ...
    //     }
    //   }
})(AppHelpers || (exports.AppHelpers = AppHelpers = {}));
